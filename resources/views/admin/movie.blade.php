...
<form id="fileUploadForm" class="movie-form" action="/admin/movies/{{ $movie->slug }}/edit" method="POST" enctype="multipart/form-data">
    @csrf
    <label for="title">Title
    <input type="text" name="title" id="title" value="{{ $movie->title }}"></label>
    @error('title')
    <div class="error_msg">{{ $message }}</div>
    @enderror

    <label for="year">Year
    <input type="text" name="year" id="year" value="{{ $movie->year }}"></label>
    @error('year')
    <div class="error_msg">{{ $message }}</div>
    @enderror

    <label for="duration">Duration
    <input type="text" name="duration" id="duration" value="{{ $movie->duration }}"></label>
    @error('duration')
    <div class="error_msg">{{ $message }}</div>
    @enderror

    <label for="desc">Description
    <textarea type="text" name="desc" id="desc"> {{ $movie->desc }} </textarea></label>
    @error('desc')
    <div class="error_msg">{{ $message }}</div>
    @enderror
    ...
    <button class="button" type="submit" onclick="">Update Movie</button>
